...
export default function HomePage() {
  return (
    <div className="p-6 text-right">
      <h1 className="text-3xl font-bold mb-6">مرحبًا بك في المخزن للاتحاد</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Link to="/items" className="bg-white shadow hover:shadow-md p-6 rounded-lg border text-center">
          <h2 className="text-xl font-semibold mb-2">📦 العناصر</h2>
          <p className="text-sm text-gray-500">إضافة، تعديل، حذف أو عرض عناصر المخزون</p>
        </Link>
        ...
        <Link to="/movements" className="bg-white shadow hover:shadow-md p-6 rounded-lg border text-center">
          <h2 className="text-xl font-semibold mb-2">🔄 الحركات</h2>
